...
import com.example.ly.weather.R;
...
public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(context).inflate(R.layout.mylistview, null);
                holder = new ViewHolder();
                holder.tv_ss = (TextView) convertView.findViewById(R.id.cityname);
